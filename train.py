...
from UNETGAN.training import fit_models
...
def main():
    ...
    print("start training of ", num_labelled_images, " labelled images for epochs ",  epochs, "and paired are, ", num_paired_images)
    fit_models(classifier, attention, training_generator_labelled_unlabelled, training_generator_labelled, batch_size, epochs, num_labelled_images, num_paired_images,  writer)
